...
<html lang="en">
    <head>
        ...
        <div class="container">
        <div class="col">
                <span class="thored navbar-brand">Notification</span>
            </div>
            <span class="dropdown">
            ...
            <div class="container">
                <div class="channel-bg">
                    <div class="joinslot row d-flex justify-content-start align-items-center" >
                        ...
                        <div class="col" >
                            ...
                            <div class="col">
                                <h6 class="float-start">Jack's Channel has created a new schedule</h6>
                                <br>
                                <label class="float-start">Aug 13, 2021 - 22:00</label>
                            </div>
                        </div>
                    </div>
                ...
                <nav class="navbar navbar-dark navbar-expand fixed-bottom">
                    <div class="container">
                        ...
                        <li class="nav-item">
                            <a href="#" class="navtext nav-link">Channels</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="navtext nav-link">Schedule</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="navtext nav-link active">Notification</a>
                        </li>
                        </ul>
                    </div>
                </nav>
